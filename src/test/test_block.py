...
from ..block import \
    block_to_block_type, \
    block_type_heading, \
    block_type_code, block_type_quote, block_type_unordered_list, block_type_ordered_list, block_type_paragraph, \
...
class TestBlock(unittest.TestCase):
    ...
    def test_block_type(self):
        ...
        block_type = block_to_block_type(">This is quote block\n>Next line")
        self.assertEqual(block_type_quote, block_type)
        block_type = block_to_block_type("*This is quote block\n*Next line")
        self.assertEqual(block_type_unordered_list, block_type)
        block_type = block_to_block_type("1. This is quote block\n2. Next line")
